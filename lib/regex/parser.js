...
module.exports = (function () {
  ...
  function u (n) {
    ...
    function c () {
      let l, u, t, r, o
      return l = qt, u = i(), u !== null
        ? (t = qt, n.charCodeAt(qt) === 124
            ? (r = fl,
              qt++)
            : (r = null, Wt === 0 && e(sl)), r !== null
            ? (o = c(), o !== null
                ? (r = [r, o],
                  t = r)
                : (qt = t, t = il))
            : (qt = t, t = il), t === null && (t = al), t !== null
            ? (Lt = l,
              u = hl(u, t), u === null ? (qt = l, l = u) : l = u)
            : (qt = l, l = il))
        : (qt = l,
          l = il), l
    }
    ...
    function d () {
      let n, l, u
      return Wt++, n = qt, l = p(), l !== null
        ? (u = k(), u === null && (u = al), u !== null
            ? (Lt = n,
              l = Tl(l, u), l === null ? (qt = n, n = l) : n = l)
            : (qt = n, n = il))
        : (qt = n,
            ...
            ? (n.charCodeAt(qt) === 44
                ...
                ? (o = T(), o !== null
                    ? (n.charCodeAt(qt) === 125
                        ? (c = Fl,
                          qt++)
                        : (c = null, Wt === 0 && e(Ql)), c !== null
                        ? (Lt = l, u = Sl(t, o), u === null
                            ? (qt = l,
                              l = u)
                            : l = u)
                        : (qt = l, l = il))
      ...
      u !== null
        ? (t = T(), t !== null
            ? (n.substr(qt, 2) === Ul
                ...
                : (r = null,
                  Wt === 0 && e(El)), r !== null
                ? (Lt = l, u = Gl(t), u === null ? (qt = l, l = u) : l = u)
                : (qt = l,
                  l = il))
            : (qt = l, l = il))
        : (qt = l, l = il), l
      ...
      u !== null
        ? (t = T(), t !== null
            ? (n.charCodeAt(qt) === 125
                ...
                : (r = null,
                  Wt === 0 && e(Ql)), r !== null
                ? (Lt = l, u = Bl(t), u === null ? (qt = l, l = u) : l = u)
                : (qt = l,
                  l = il))
            : (qt = l, l = il))
        : (qt = l, l = il), l
    ...
    function T () {
      let l, u, t
      if (l = qt, u = [], zl.test(n.charAt(qt))
        ? (t = n.charAt(qt), qt++)
        : (t = null,
          Wt === 0 && e(Il)), t !== null) {
        for (;t !== null;) {
          u.push(t), zl.test(n.charAt(qt))
            ? (t = n.charAt(qt),
              qt++)
            : (t = null, Wt === 0 && e(Il))
        }
    ...
    function x () {
      ...
      u !== null
        ? (t = R(), t === null && (t = F(), t === null && (t = m(), t === null && (t = y()))),
          t !== null
            ? (n.charCodeAt(qt) === 41 ? (r = Pl, qt++) : (r = null, Wt === 0 && e(Vl)),
              r !== null
                ? (Lt = l, u = Xl(t), u === null ? (qt = l, l = u) : l = u)
                : (qt = l,
                  l = il))
            : (qt = l, l = il))
        : (qt = l, l = il), l
    ...
    function y () {
      let n, l
      return n = qt, l = c(), l !== null && (Lt = n, l = Yl(l)), l === null
        ? (qt = n,
          n = l)
        : n = l, n
    }
    function m () {
      ...
      u !== null
        ? (t = c(), t !== null
            ? (Lt = l, u = nu(t), u === null ? (qt = l, l = u) : l = u)
            : (qt = l,
              l = il))
        : (qt = l, l = il), l
    }
    function R () {
      ...
      u !== null
        ? (t = c(), t !== null
            ? (Lt = l, u = tu(t), u === null ? (qt = l, l = u) : l = u)
            : (qt = l,
              l = il))
        : (qt = l, l = il), l
    }
    function F () {
      ...
      u !== null
        ? (t = c(), t !== null
            ? (Lt = l, u = ou(t), u === null ? (qt = l, l = u) : l = u)
            : (qt = l,
              l = il))
        : (qt = l, l = il), l
    }
    function Q () {
      ...
      u !== null) {
        ...
        t === null && (t = al), t !== null) {
          ...
          r !== null
            ? (n.charCodeAt(qt) === 93 ? (o = fu, qt++) : (o = null, Wt === 0 && e(su)),
              o !== null
                ? (Lt = l, u = hu(t, r), u === null ? (qt = l, l = u) : l = u)
                : (qt = l,
                  l = il))
            : (qt = l, l = il)
        } else qt = l, l = il
    ...
    function S () {
      let l, u, t, r
      return Wt++, l = qt, u = U(), u !== null
        ? (n.charCodeAt(qt) === 45
            ? (t = pu, qt++)
            : (t = null,
              Wt === 0 && e(vu)), t !== null
            ? (r = U(), r !== null
                ? (Lt = l, u = wu(u, r), u === null
                    ? (qt = l,
                      l = u)
                    : l = u)
                : (qt = l, l = il))
    ...
    function $ () {
      let l, u
      return Wt++, l = qt, mu.test(n.charAt(qt))
        ? (u = n.charAt(qt), qt++)
        : (u = null,
    ...
    function Y () {
      ...
      u !== null
        ? (n.length > qt ? (t = n.charAt(qt), qt++) : (t = null, Wt === 0 && e(vt)),
          t !== null
            ? (Lt = l, u = wt(t), u === null ? (qt = l, l = u) : l = u)
            : (qt = l,
              l = il))
        : (qt = l, l = il), l
    }
    function Z () {
      ...
      u !== null
        ? (gt.test(n.charAt(qt)) ? (t = n.charAt(qt), qt++) : (t = null, Wt === 0 && e(bt)),
          t !== null
            ? (Lt = l, u = kt(t), u === null ? (qt = l, l = u) : l = u)
            : (qt = l,
              l = il))
        : (qt = l, l = il), l
    }
    function _ () {
      ...
      u !== null) {
        ...
        t !== null
          ? (Lt = l, u = Rt(t), u === null ? (qt = l, l = u) : l = u)
          : (qt = l,
            l = il)
      } else qt = l, l = il
      return l
    ...
    function nl () {
      ...
      u !== null) {
        ...
        t !== null
          ? (Lt = l, u = Et(t), u === null ? (qt = l, l = u) : l = u)
          : (qt = l,
            l = il)
      } else qt = l, l = il
      return l
    ...
    function ll () {
      ...
      u !== null) {
        ...
        t !== null
          ? (Lt = l, u = jt(t), u === null ? (qt = l, l = u) : l = u)
          : (qt = l,
            l = il)
      } else qt = l, l = il
      return l
    ...
    function tl () {
      ...
      u !== null
        ? (n.length > qt ? (t = n.charAt(qt), qt++) : (t = null, Wt === 0 && e(vt)),
          t !== null
            ? (Lt = l, u = bu(t), u === null ? (qt = l, l = u) : l = u)
            : (qt = l,
              l = il))
        : (qt = l, l = il), l
    }
